...
import { Sparkles, CheckCircle2, ShieldCheck, DollarSign, Cpu, Zap, HardDrive, Wifi, Copy, Check, Download, Layers, Code2, Shield, Bookmark, HelpCircle, Network, Activity, Lock } from 'lucide-react';
...
export default function RecommendationResult({ result, userInput }) {
  ...
  const { primary, budgetPick, perfPick, totalEvaluated } = result;
...
Generated by Infrasence Cloud Recommendation Engine
  ...
  const architecturalReasons = [
    {
      key: 'needMonitoring',
      name: 'CloudWatch Alarms & Monitoring',
      icon: Activity,
      color: 'text-cyan-400',
      reason: 'Why Suggested? You answered YES to 24/7 Monitoring. CloudWatch tracks CPU/disk health and triggers instant SMS/Email alerts if load exceeds 80%.'
    },
    {
      ...
      icon: Network,
      color: 'text-blue-400',
      reason: 'Why Suggested? You answered YES to spiky load. ALB distributes web requests evenly across server instances to prevent downtime.'
    },
    {
      key: 'needAutoScaling',
      ...
      reason: 'Why Suggested? You answered YES to automatic capacity scaling. ASG launches extra servers during traffic spikes and cuts idle servers when traffic drops.'
    },
    {
      key: 'needMultiAZ',
      ...
      reason: 'Why Suggested? You answered YES to Disaster Recovery. Multi-AZ replicates databases and subnets across 2 physical data centers for 99.99% uptime.'
    },
    {
      key: 'needEncryption',
      name: 'KMS AES-256 Disk Encryption',
      icon: Lock,
      color: 'text-purple-400',
      reason: 'Why Suggested? You answered YES to Encryption. KMS automatically encrypts all EBS hard drives and S3 buckets at rest using AES-256.'
    }
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 animate-fadeIn">
      ...
      <div className="glass-panel p-2 bg-slate-950/90 border border-slate-800 flex items-center justify-between overflow-x-auto gap-2">
        <div className="flex items-center gap-1.5 overflow-x-auto">
          ...
          >
            ...
            <span>🎯 Primary Specs & Reasons</span>
          </button>
      ...
      {activeOutputTab === 'specs' && (
        <div className="space-y-8 animate-fadeIn">
          ...
          <div className="glass-panel p-8 sm:p-12 border-2 border-cyan-500/40 relative overflow-hidden shadow-2xl space-y-8">
            <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-800/80 pb-6">
              <div className="flex items-center gap-3 flex-wrap">
                <span className="glow-badge px-4 py-2 rounded-full text-xs font-bold font-mono tracking-wide flex items-center gap-2">
                  <Sparkles className="w-4 h-4 text-cyan-400" />
                  {primary.score}% MATCH SCORE
                </span>
                <span className="px-4 py-2 rounded-full text-xs font-bold font-mono uppercase bg-slate-800 text-slate-200 border border-slate-700">
                  {instance.provider} Cloud
                </span>
                {instance.burstable ? (
                  <span className="px-3.5 py-1.5 rounded-xl text-xs font-bold bg-amber-500/15 text-amber-300 border border-amber-500/40">
                    🌱 Smart Money-Saver Tier
                  </span>
                ) : (
                  <span className="px-3.5 py-1.5 rounded-xl text-xs font-bold bg-emerald-500/15 text-emerald-300 border border-emerald-500/40">
                    🛡️ Guaranteed 24/7 Power
                  </span>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
              <div className="md:col-span-2 space-y-3">
                ...
                <p className="text-base text-slate-200 font-semibold">{instance.family}</p>
                <p className="text-xs sm:text-sm text-slate-300 leading-relaxed pt-1">{instance.description}</p>
              </div>

              <div className="bg-slate-900/90 p-6 sm:p-8 rounded-3xl border border-slate-800 text-right md:text-left space-y-2 shadow-inner">
                ...
                <div className="text-4xl font-extrabold font-mono text-cyan-300">
                  ...
                  <span className="text-sm text-slate-400 font-sans font-normal ml-1">/mo</span>
                </div>
                <p className="text-xs text-slate-400 font-mono">~${instance.hourlyRate.toFixed(4)} / hour</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-6 border-t border-slate-800/80">
              <div className="bg-slate-900/60 p-5 rounded-2xl border border-slate-800">
                ...
                <span className="text-2xl font-mono font-extrabold text-white">{instance.vCPU} Cores</span>
              </div>
              ...
              <div className="bg-slate-900/60 p-5 rounded-2xl border border-slate-800">
                ...
                <span className="text-2xl font-mono font-extrabold text-white">{instance.ramGB} GB RAM</span>
              </div>
              ...
              <div className="bg-slate-900/60 p-5 rounded-2xl border border-slate-800">
                ...
                <span className="text-2xl font-mono font-extrabold text-white">{instance.maxIops.toLocaleString()} IOPS</span>
              </div>
              ...
              <div className="bg-slate-900/60 p-5 rounded-2xl border border-slate-800">
                ...
                <span className="text-base font-mono font-bold text-white leading-7">{instance.networkSpeed}</span>
              </div>
            </div>
          </div>
