  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 sm:space-y-10 animate-fadeIn">
      ...
      <div className="glass-panel p-8 sm:p-12 border-2 border-emerald-500/40 space-y-8 shadow-2xl">
        ...
        <div className="space-y-3">
          <span className="text-xs font-bold text-emerald-400 uppercase font-mono">RECOMMENDED SERVERLESS SERVICE</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-slate-800">
          <div className="bg-slate-900/60 p-4 rounded-xl border border-slate-800">
            ...
            <span className="text-xs font-bold text-emerald-300 font-mono leading-relaxed">{srv.pricingModel}</span>
          </div>
          <div className="bg-slate-900/60 p-4 rounded-xl border border-slate-800">
